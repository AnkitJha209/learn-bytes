    ...
    >
      ...
      <FaLock style={{color:"grey",position:"absolute",top:"calc(42%)",left:"1.65%",fontSize:"20px"}}/>
        ...
        <input
          ...
          className="w-full rounded-[0.5rem] bg-gray-200 p-[12px] pr-12 text-gray-800"
        />
        <span
      ...
      <button
        type="submit"
        className="mt-6 rounded-[8px] bg-gray-200 py-[8px] px-[12px] font-medium text-gray-900 hover:bg-emerald-500"
      >
        Sign In
      </button>
    </form>
